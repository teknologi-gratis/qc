...
class SaksiPemilihanController extends Controller
{
    /**
    ...
    public function index($id)
    {
        ...
        return view('admin_lembaga.saksi_pemilihan.index', compact('items','pemilihan','id'));
    }
    ...
    public function create($id)
    {
        ...
        return view('admin_lembaga.saksi_pemilihan.create', compact('id','pemilihan'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin_lembaga.saksi_pemilihan.edit', compact('item','id'));  
    }
    ...
    public function import_excel(Request $request)
    {
	    ...
	    return redirect('admin_lembaga/pemilihan/saksi/{id}');
    }  
}
