...
class PemilihanLembagaController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('admin.gabungan.index_gabungan', compact('items'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.gabungan.create_pemilihan', compact('provinsi_untuk_select2','kabupaten_untuk_select2'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.gabungan.edit_pemilihan', compact('item','provinsi_untuk_select2','kabupaten_untuk_select2'));
    }
