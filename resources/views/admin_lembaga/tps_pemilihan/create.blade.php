...
<div class="bgc-white bd bdrs-3 pB-50 mB-20">        
        ...
        <a href="{{ url('/admin_lembaga/pemilihan/tps', $id) }}" class="btn btn-secondary pull-right mR-10 mT-5">
...
@section('content')
	{!! Form::open([
			'action' => ['Admin_lembaga\TpsPemilihanController@store'],
			'files' => true
		])
	!!}

		@include('admin_lembaga.tps_pemilihan.form')
