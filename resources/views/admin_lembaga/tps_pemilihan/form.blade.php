<div class="row mB-40">
	<div class="col-sm-12">
		<div class="bgc-white p-20 bd">
				...
				{!! Form::myInput('total_suara', 'total_suara', 'Total Suara', array('disabled')) !!}
		
				{!! Form::myInput('suara_tidak_sah', 'suara_tidak_sah', 'Suara Tidak Sah', array('disabled')) !!}
				...
				{!! Form::mySelect('saksi', 'Saksi', $saksi_untuk_select2, isset($item->saksi_id) ? $item->saksi_id : null, ['class' => 'form-control select2']) !!}
